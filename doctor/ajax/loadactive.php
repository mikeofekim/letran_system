...
$sql = "SELECT * FROM  consultations a INNER JOIN useraccount b ON a.patientID = b.userAccountID INNER JOIN usertbl c ON b.linkedAccount = c.userID  WHERE a.doctorID = " . $_SESSION['userid'] . " AND status = 1 ORDER BY a.consultationID DESC";
