        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($row['outgoing_msg'] == $myid) { //sender
                ...
                if ($row['type'] == 0) {
                    ...
                    echo "<div class='d-flex justify-content-end mb-2'><div class='shadow bg-primary sender p-2 text-white ' style='max-width: 300px'><img class='round-2' src='../assets/uploads/" . $row['message'] . "' height='150'><div class='smallTxt'>" . $date . "</div></div></div>";
                }
            } else { //receiver
                ...
                if ($row['type'] == 0) {
                   ...
                   <div class='me-1'>
                    <img src='../assets/images/profiledefault.png' height='35' class='round-2 shadow bg-light' />
                      </div>
                   <div class='shadow bg-info receiver p-2 text-white' style='max-width: 300px'>" . $row['message'] . "</span><div class='smallTxt'>" . $date . "</div></div>
                    ...
                    <div class='shadow bg-info receiver p-2 text-white' style='max-width: 300px'><img class='round-2' src='../assets/uploads/" . $row['message'] . "' height='150'><div class='smallTxt'>" . $date  . "</div></div>
                   </div>";
                }
            }
        }
