...
$sql = "SELECT * FROM useraccount a INNER JOIN teachers b ON a.linkedAccount = b.doctorID WHERE a.linkedAccount=$id AND a.userType = 2";
...
<link rel="shortcut icon" href="components/favicon.png" type="image/x-icon">
    ...
    <title>Letran - Manaoag | View Profile</title>
    <style>
        .mygradient {
...
<body>
            ...
            <div class="col-md-9 col-sm-12 col-12">
                <div class="vh-100 py-3">
                    <div class="p-3">
                        ...
                        <div class="h4 mb-0 fw-bold"><a href="doctors.php"><i class="fas fa-angle-left"></i></a> Teachers</div>
    ...
    <script>
        ...
        $("#doctorform").submit(function(e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Update Teacher's information.",
                icon: 'warning',
