        ...
        <div class="card-body">
            <div class=" py-2">
                ...
                <div class="d-flex flex-row align-items-center my-4">
                    <div class="mb me-2"><img src="../assets/images/admin.png" class="round" height="60" width="60" alt=""></div>
                    <div class="">
                        <div class="h5 mb-0 fw-bold text-nowrap">Administrator</div>
                        <div class="h6 mb-0 "><span class="badge bg-primary">System</span></div>
                    </div>
                </div>
