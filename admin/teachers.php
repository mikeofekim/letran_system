...
<head>
    ...
    <title>Letran - Manaoag | Teachers</title>
    <style>
        .mygradient {
        ...
        <div class="row m-0">
            ...
            <div class="col-md-9 col-sm-12 col-12">
                <div class="vh-100 py-3">
                    <div class="p-3">
                        <div class="float-end">
                            <button class="btn btn-sm btn-light border shadow-sm round-1 px-3 fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Teacher <i class="fas fa-user-plus"></i></button>
                        </div>
                        <div class="h4 mb-0 fw-bold">Teachers</div>
                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between">
                                            <div class="w-100 me-3">
                                                <input type="text" class="form-control round-2 mb-3" id="keyword" placeholder="Search Teacher">
                                            </div>
                                            <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="doctorform" method="post" action="">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="smallTxt">Teacher ID #</div>
                                <input type="text" class="form-control mb-2" name="license" required>
                            </div>
                            <div class="col-md-4">
                                <div class="smallTxt">Courses</div>
                            ...
                            <div class="col-md-6">
                                <div class="smallTxt">Department</div>
    ...
    <script>
        ...
        function loadMe() {
            ...
            setTimeout(function() {
                ...
                $("#doctorlists").load('ajax/loadTeacher.php', {
                        keyword: keyword
                    },
        ...
        $("#doctorform").submit(function(e) {
            e.preventDefault();
            $.post('ajax/addTeacher.php', $("#doctorform").serialize(), function(data) {
                if (data == 1) {
                    Swal.fire(
                        'Success!',
