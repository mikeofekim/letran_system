...
<body>
        ...
        <div class="row m-0">
            ...
            <div class="col-md-9 col-sm-12 col-12">
                <div class=" mt-4 data" id="data">
                    <div class="p-3">
                        <div class="h4 mb-0" data-aos="flip-up"><?= $message ?> <span class="fw-bold"><?= $_SESSION['user']['firstName'] ?>,</span></div>
                        <hr>
                        <div class="row mt-3">
                            <div class="col-md-12">
    ...
    <script>
        ...
        $.post("ajax/loadreport1.php", function(response) {
            ...
            var myChart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: ["9/07", "9/08", "9/09", "9/10", "9/11", "9/12", "9/13"],
                    datasets: [{
                        label: "",
                        data: result[1],
                        tension: 0.5
