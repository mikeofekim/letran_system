...
$sql = "UPDATE `teachers` SET `firstName`='$fname',`middleName`='$mname',`lastName`='$lname',`specialization`='$sp',`address`='$address',`email`='$email',`contact`='$contact',`license`='$license',`hospital`='$hospital',`h_address`='$h_address' WHERE doctorID= $id";
