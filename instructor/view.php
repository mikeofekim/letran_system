                    ...
                    <div class="p-3">
                        ...
                        <div class="row mycontent " id="main">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="smallTxt fw-bold" data-aos="fade-up">Description</div>
                                <div class="h6 fw-light lh-base " data-aos="fade-up">
                                    <?= $issue['description'] ?>
                                </div>
                                <hr>
                                <div class="smallTxt fw-bold" data-aos="fade-up">Medical Information</div>
                                <div class="h6 fw-light lh-base" data-aos="fade-up">
                                    <?= $issue['medicalCondition'] ?>
                                </div>
                                <hr>
                                <div class="smallTxt fw-bold" data-aos="fade-up">Treatment</div>
                                <div class="h6 fw-light lh-base" data-aos="fade-up">
