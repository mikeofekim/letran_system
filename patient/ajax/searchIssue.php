...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        echo '<div class="col-md-4 " ><div class=" bg-light round-2 p-3 mb-3 issues shadow-sm" style="height: 100px" onclick="window.location.href=\'view.php?id=' . $row['id'] . '\'" data-aos="">';
