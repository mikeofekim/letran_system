                    ...
                    <div class="p-3">
                        ...
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="smallTxt fw-bold">Birthday</div>
                                    <input type="date" class="form-control round-2 mb-2 shadow-sm" value="<?= $user['birthday'] ?>" readonly>
                                    <!-- onclick="editThis('birthday', 'date', '', '', $(this).val())" -->
                                </div>
                                <div class="col-md-4">
                                    <div class="smallTxt fw-bold">Gender</div>
                                    <select name="" id="" class="form-select round-2" disabled>

                                        <option value="" <?= ($user['gender'] == 0) ? "selected" : "" ?>>Male</option>
                                        <option value="" <?= ($user['gender'] == 1) ? "selected" : "" ?>>Female</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="smallTxt fw-bold">Phonenumber</div>
                                    <input type="text" class="form-control round-2 mb-2 pointer shadow-sm " value="<?= $user['phonenumber'] ?>" readonly onclick="editThis('phonenumber', 'text', '[0-9]{11}', 'Enter your new phonenumber', $(this).val())">
                                </div>
                                <div class="col-md-4">
                                    <div class="smallTxt fw-bold">Address</div>
                                    <input type="text" class="form-control round-2 mb-2" value="<?= $user['muncity'] . ', ' . $user['province'] ?>" readonly>
                                </div>
